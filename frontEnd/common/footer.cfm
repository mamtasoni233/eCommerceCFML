            ...
            <div class="container d-flex justify-content-center align-items-center py-2">
                ...
                <ul class="list-unstyled d-flex justify-content-start align-items-center mb-0 ms-3 lh-1">
                    <li class="mx-1 mb-0 lh-1">
                        <a class="text-muted text-decoration-none opacity-75-hover transition-all lh-1" href="##">
        ...
        <div class="container pt-8">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <p class="text-muted m-0">
                    Follow us on Instragram <span class="text-lowercase">@Alpine</span>
                </p>
                    ...
                    >
                        ...
                        <div class="ms-lg-4">
                            ...
                            <small class="text-muted">
                                <a class="text-muted" href="##">Click here</a> to chat with our support team
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-in">
                <div class="row my-4 flex-wrap">
                    ...
                    <div class="col-12 col-md-5">
                        ...
                        <p class="opacity-75">
                            Sign up to our newsletter and we'll email you a code worth 15%
                            off your first order. By subscribing to our mailing list you agree to our terms and conditions.
                        </p>
                        <form
                ...
                >
                    <p class="small opacity-75">
                        &copy; 2021 Alpine All Rights Reserved. Template by <a
                            class="text-white"
